...
self.addEventListener('fetch', async (event) => {
  ...
  if (((request.url.includes('api') && !request.url.includes('chrome-extension') && !request.url.includes('chat')) || request.url.includes('EnvironmentVariableServlet')) && hostURL.port !== '4502') {
